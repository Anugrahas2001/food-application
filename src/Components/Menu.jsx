...
function Menu() {
  ...
  return (
    <div>
      ...
      <Header/>
      <Banner/>
      {!loading?<Specialdishes specialdishes={food}/>:<Loader/>}
      {!loading?<Filtereddishes filteredDish={filteredDishes} singleDish={singleDish} setSingleDish={setSingleDish} foodMenu={food}/>:null}
      <Footer/>
    </div>
  )
}
